...
<div class="lat">
    <h2 class="lat_title">
        <?php if ($is_admin == 'super') { ?>
            <a class="list_title" href="<?php echo get_pretty_url($bo_table); ?>">
                <?php echo $bo_subject ?>
            </a>
        <?php } else { ?>
            <span class="list_title"><?php echo $bo_subject ?></span>
        <?php } ?>
        <span class="list_count">(<?php echo number_format($list_count) ?>)</span>
    </h2>
    <ul class="portfolio-list">
    <?php for ($i=0; $i<$list_count; $i++) {  ?>
        <li class="basic_li" data-name="<?php echo $list[$i]['wr_id'];?>" data-board="<?php echo $bo_subject; ?>">
            <div class="list_wrap">
