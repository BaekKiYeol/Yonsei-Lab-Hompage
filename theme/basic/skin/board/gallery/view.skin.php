...
<article id="bo_v" class="inner" style="width:<?php echo $width; ?>">
    <header>
        ...
        <h2 id="bo_v_title">
            ...
            ?></span>
            <div class="gall_view_date"><?php echo date("Y.m.d", strtotime($view['datetime'])) ?></div>
        </h2>
    </header>
	        ...
	        <ul class="btn_bo_user bo_v_com">
	        	...
	        	<li>
		        	...
		        	<ul class="more_opt is_view_btn"> 
			            <?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>">수정<i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                            <!-- 수정 -->
                        </a></li><?php } ?>
...
;
    ...
    <section id="bo_v_atc">
        ...
        if($v_img_count) {
         ...
         ?>
        <!-- <div><?php echo $view['wr_link1']; ?></div> -->
        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con"><p><?php echo get_view_thumbnail($view['content']); ?></p>
            <button class="back-life-btn" value="back-life" onClick="history.go(-1)">
                < Back to Life
            </button>
        </div>

        <form name="fboardlist" id="fboardlist" action="http://localhost/yonsei/bbs/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
        ...
        <div id="bo_btn_top">
            ...
            <ul class="btn_bo_user">
                ...
                <li>
                    <a
                        href="http://localhost/yonsei/bbs/write.php?bo_table=gallery"
                        class="btn_b01 btn"
                        title="글쓰기">글쓰기<i class="fa fa-pencil" aria-hidden="true"></i>
        ...
        <ul id="gall_ul" class="gall_view">
            <li class="gall_li col-gn-4">
                <div class="gall_box">

                    <div class="gall_con">
                        <div class="gall_img">
                            <a href="http://localhost/yonsei/bbs/board.php?bo_table=gallery&amp;wr_id=5">

                                <img
                                    src="http://localhost/yonsei/data/file/gallery/thumb-0_DVMAcEY2_14d480c44187b262dcb1008545a9132dae673948_202x150.png"
                                    alt=""
                                    title=""></a>
                                <div class="gall_sub">
                                    <div class="subject">2022 SCBEL 송년회</div>
                                    <div class="gall_date"></div>2023.03.20
                                </div>
                            </div>
                ...
                <li class="gall_li col-gn-4">
                    <div class="gall_box">
                        <div class="gall_con">
                            <div class="gall_img">
                                <a href="http://localhost/yonsei/bbs/board.php?bo_table=gallery&amp;wr_id=4">

                                    <img
                                        src="http://localhost/yonsei/data/file/gallery/thumb-0_gvYte8RZ_2b06d5cfeb4a70d456b2ef3e9f7da3b338870ace_202x150.png"
                                        alt=""></a>
                                    <div class="gall_sub">
                                        <div class="subject">2022 TERMIS-AP</div>
                                        <div class="gall_date"></div>2023.03.20
                                    </div>
                                </div>
                                <div class="gall_option"></div>
                    ...
                    <li class="gall_li col-gn-4">
                        <div class="gall_box">
                            <div class="gall_con">
                                <div class="gall_img">
                                    <a href="http://localhost/yonsei/bbs/board.php?bo_table=gallery&amp;wr_id=3">

                                        <img
                                            src="http://localhost/yonsei/data/file/gallery/thumb-0_Q9XCmvdt_c2ca37e965796afcd9d3fe1408e2136253f9487e_202x150.png"
                                            alt=""></a>
                                        <div class="gall_sub">
                                            <div class="subject">2022 하계 공동 워크샵</div>
                                            <div class="gall_date"></div>2023.03.20
                                        </div>
                                    </div>
                        ...
                        <li class="gall_li col-gn-4">
                            <div class="gall_box">
                                <div class="gall_con">
                                    <div class="gall_img">
                                        <a href="http://localhost/yonsei/bbs/board.php?bo_table=gallery&amp;wr_id=2">

                                            <img
                                                src="http://localhost/yonsei/data/file/gallery/thumb-0_vGNMelo4_0d4f60400690ddcb2f2c8750fc95d913d18fde33_202x150.png"
                                                alt=""></a>
                                            <div class="gall_sub">
                                                <div class="subject">2022-1 SCBEL 액티비티&amp;회식</div>
                                                <div class="gall_date"></div>2023.03.20
                                            </div>
                                        </div>
