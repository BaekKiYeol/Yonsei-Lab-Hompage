...
<div id="bo_gall" class="inner" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_btn_top">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="글쓰기">글쓰기<i class="fa fa-pencil" aria-hidden="true"></i><span class="sound_only">글쓰기</span></a></li><?php } ?>
                ...
                <div class="gall_con">
                    <div class="gall_img">
                        ...
                        <div class="gall_sub">
                            ...
                            <div class="gall_date"></div><?php echo date("Y.m.d", strtotime($list[$i]['datetime'])) ?>
                        </div>
                    </div>
