...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <?php if($bo_table == 'people' && ($sca=='Principal Investigator')) { ?>
    <section id="bo_v_atc">
        ...
        <div class="view-box">
            <div class="view-wrap">
                <div class="img-box">
                    ...
                    ?>
                    <div class="wr_9"><?php echo $view['wr_9'];?></div>
                </div>

                <div class="gall-info">
                    <div class="info-txt2">INFORMATION</div>
                    <?php echo $view['wr_3'];?>
                    <div class="rsch-its2">Degree & Education</div>
                    <?php echo $view['wr_4'];?>
                </div>
            </div>
            <div class="etc-title v2">Professional Experience</div>
            <div class="etc-list"><?php echo $view['wr_5'];?></div>
            <div class="etc-title v2">AWARDS & HONORS</div>
            <div class="etc-list list2"><?php echo $view['wr_6'];?></div>
    ...
    <?php } else {?>
        ...
        <!-- 카테고리 PRINCIPAL INVESTIGATOR 말고 다른것들 -->
        <section id="bo_v_atc">
        <h2 id="bo_v_atc_title">본문</h2>
        ...
        <div class="view-box">
            <div class="view-wrap">
                ...
                <div class="gall-info">
                    <div class="info-txt2">INFORMATION</div>
                    <div class="wr_email email2"><?php echo $view['wr_email'];?></div>
                    <div class="wr_content"><?php echo $view['wr_content'];?></div>
                    <div class="rsch-its2">RESEARCH INTERESTS</div>
                    <?php echo $view['wr_2'];?>
                </div>
            </div>
    ...
    <ul class="bo_v_nb">
        <?php if ($prev_href) { ?>
            <li class="btn_prv"><span class="nb_tit"><i class="fa fa-chevron-up" aria-hidden="true"></i> 이전글</span><a href="<?php echo $prev_href ?>"><?php echo $prev_wr_subject;?></a> 
                <!-- <span class="nb_date"><?php echo str_replace('-', '.', substr($prev_wr_date, '2', '8')); ?></span> -->
            </li>
        <?php } ?>
        <?php if ($next_href) { ?>
            <li class="btn_next"><span class="nb_tit"><i class="fa fa-chevron-down" aria-hidden="true"></i> 다음글</span><a href="<?php echo $next_href ?>"><?php echo $next_wr_subject;?></a> 
