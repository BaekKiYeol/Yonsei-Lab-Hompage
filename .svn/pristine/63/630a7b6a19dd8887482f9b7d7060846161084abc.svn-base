...
<article id="bo_v" class="inner" style="width:<?php echo $width; ?>">
    <header class="gall-head2">
        <div class="list-title-wrap v2">
            <div class="title">
            <h1>Cover</h1>
            </div>
            <div class="title-path">
            Home &nbsp; > &nbsp; Publications &nbsp; > &nbsp; <span class="list-title2">Cover</span>
            </div>
        </div>
        ...
        <h2 id="bo_v_title2">
            ...
            ?></span>
            <div class="gall_view_date"><b><?php echo date("Y.m.d", strtotime($view['datetime'])) ?></b></div>
        </h2>
    </header>
        ...
        <div class="gallery-slide_">
            <div class="swiper gallery-slide">
                ...
                <div class="swiper-button-next">
                    <img src="<?php echo G5_URL ?>/assets/images/user/ico_next.svg" alt="">
                </div>
                <div class="swiper-button-prev">
                    <img src="<?php echo G5_URL ?>/assets/images/user/ico_prev.svg" alt="">
                </div>
    ...
    <script>
        ...
        <div id="bo_v_con"><p><?php echo get_view_thumbnail($view['content']); ?></p>
            <button class="back-life-btn" id="back-life-btn" value="back-life">
                <a href="/yonsei/bbs/board.php?bo_table=gallery">
                    < Back to Cover
                </a>
            </button>
        </div>
