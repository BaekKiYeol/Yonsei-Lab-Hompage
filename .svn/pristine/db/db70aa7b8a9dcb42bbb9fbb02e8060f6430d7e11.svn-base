...
<article id="bo_v" class="request_wrap inner" style="width:<?php echo $width; ?>">
    <header>
        <h2 id="bo_v_title">
...
;
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_con">
        <div class="tb_request">
            <div class="pdtb">
                <?php if($view['ca_name'] == 'SOLUTION'){ ?>
                    <div class="pdtb_">
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">회사명</li>
                            <li class="pdtb_td"><?php echo $view['wr_11'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">담당자명/직책</li>
                            <li class="pdtb_td"><?php echo $view['wr_12'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">이메일</li>
                            <li class="pdtb_td"><?php echo $view['wr_13'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">연락처</li>
                            <li class="pdtb_td"><?php echo $view['wr_14'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">회사 홈페이지</li>
                            <li class="pdtb_td"><?php echo $view['wr_15'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">프로젝트 내용</li>
                            <li class="pdtb_td"><?php echo $view['wr_16'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">기타 <br> (소통파이브를 어떻게 알게 되었나요?)</li>
                            <li class="pdtb_td"><?php echo $view['wr_17'] ?></li>
                        </ul>
                    </div>
                <?php }else { ?>
                    <div class="pdtb_">
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">프로젝트 종류</li>
                            <li class="pdtb_td"><?php echo $view['wr_1'] ?></li>
                        
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">프로젝트 성격</li>
                            <li class="pdtb_td"><?php echo $view['wr_2'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">프로젝트 기간</li>
                            <li class="pdtb_td"><?php echo $view['wr_3'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">프로젝트 예산</li>
                            <li class="pdtb_td"><?php echo $view['wr_4'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">회사명</li>
                            <li class="pdtb_td"><?php echo $view['wr_5'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">담당자명/직책</li>
                            <li class="pdtb_td"><?php echo $view['wr_name'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">이메일</li>
                            <li class="pdtb_td"><?php echo $view['wr_email'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">연락처</li>
                            <li class="pdtb_td"><?php echo $view['wr_6'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">회사 홈페이지</li>
                            <li class="pdtb_td"><?php echo $view['wr_homepage'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">프로젝트 내용</li>
                            <li class="pdtb_td"><?php echo $view['wr_content'] ?></li>
                        </ul>
                        <ul class="pdtb_tr">
                            <li class="pdtb_th">기타 <br> (소통파이브를 어떻게 알게 되었나요?)</li>
                            <li class="pdtb_td"><?php echo $view['wr_7'] ?></li>
                        </ul>
                    </div>
                <?php } ?>             
            </div>
