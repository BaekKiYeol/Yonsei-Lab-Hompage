...
<header id="hd">
    ...
    <div id="hd_top">
        <div class="logo_img_wrap">
            <!-- <a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>"><img src="<?php echo G5_ADMIN_URL ?>/img/logo_adm.png" alt=""></a> -->
        </div>
        <!-- <button type="button" id="btn_gnb" class="btn_gnb_close <?php /*echo $adm_menu_cookie['btn_gnb'];*/?>">메뉴</button> -->
        <div id="logo"><a href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>"><span>ADMIN</span></a></div>
    ...
    <nav id="gnb" class="gnb_large <?php echo $adm_menu_cookie['gnb']; ?>">
        ...
        <div class="home_links">
            <a href="<?php echo G5_URL ?>" target="_blank">홈페이지로 가기</a>
        </div>
    </nav>
